            ...
            <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 mx-auto d-table h-100">
                <div class="d-table-cell align-middle">
                            ...
                            <div class="m-sm-3">
                                <form method="POST" action="{{ route('admin.register.post') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-lg" type="password" name="password_confirmation" placeholder="Repeat password" />
                                    </div>
                    ...
                    <div class="text-center mb-3">
                        Already have account? <a href="{{route('admin.login')}}">Log In</a>
                    </div>
                </div>
            </div>
        </div>
